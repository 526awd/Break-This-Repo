...
<header><b>CHAOS OBSERVATORY / 仓库生态博物馆</b><span>展区 001 · 猫爪巡游</span></header><nav aria-label="展区导航" style="display:flex;gap:24px;flex-wrap:wrap;margin:20px 0"><a href="index.html">猫爪足迹</a><a href="diary.html">消退日报</a><a href="atlas.html">仓库地图</a></nav>
